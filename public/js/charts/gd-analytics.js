!(function (NioApp, $) {
        ...
        if($(elm).exists() && typeof($.fn.vectorMap) === 'function') {   
            $(elm).each(function(){
                ...
                $self.vectorMap({
                    ...
                    scaleColors: ['#ccd7e2', '#da251c'],
                    selectedColor: '#da251c',
                    showTooltip: true,
    ...
    var TrafficChannelDoughnutData = {
        ...
        datasets : [{
            borderColor : "#fff",
            background : ["#da251c","#b8acff","#ffa9ce","#f9db7b"],
    ...
    var OrganicSearchData = {
        ...
        datasets : [{
            ...
            color : "#da251c",
            background : NioApp.hexRGB('#364a63',.25),
    ...
    var BounceRateData = {
        ...
        datasets : [{
            label : "Bounce Rate",
            color : "#da251c",
            background : NioApp.hexRGB('#da251c',.25),
            data: [110, 80, 125, 65, 95, 75, 90, 110, 80, 125, 70, 95]
        }]
    };
    ...
    var analyticOvData = {
        ...
        datasets : [{
            ...
            color : "#364a63",
            dash : [0,0],
            background : NioApp.hexRGB('#364a63',.15),

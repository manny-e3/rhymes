...
Route::middleware(['role:admin', 'verified'])->group(function () {
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::get('/erprev/test-endpoints', [ErpRevController::class, 'testEndpoints'])->name('erprev.test-endpoints');
        Route::post('/erprev/test-endpoints', [ErpRevController::class, 'runTestEndpoint'])->name('erprev.run-test-endpoint');
...
// Dev autologin route for verification
Route::get('/dev-login-admin', function() {
    $admin = \App\Models\User::role('admin')->first();
    if ($admin) {
        \Illuminate\Support\Facades\Auth::login($admin);
        return redirect()->route('admin.erprev.test-endpoints');
    }

...
unset($__errorArgs, $__bag); ?>" 
                                                    ...
                                                    <div class="form-note">
                                                        Minimum: ₦300,000.00 | Available: ₦<?php echo e(number_format($availableBalance, 2)); ?>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                <button type="submit" class="btn btn-primary" <?php echo e($availableBalance < 300000 ? 'disabled' : ''); ?>>
                                                    <em class="icon ni ni-wallet-out"></em>
                                                    <span>Request Payout</span>
                                                </button>
                                                <?php if($availableBalance < 300000): ?>
                                                    <div class="form-note text-danger mt-2">
                                                        ...
                                                        <?php else: ?>
                                                            Minimum balance of ₦300,000.00 required for payout
                                                        <?php endif; ?>
                                                    </div>
                                                <?php endif; ?>
                                            </div>
                            ...
                            <div class="card-inner">
                                ...
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
                                        ...
                                        <strong>Once every 30 days</strong>
                                    </li>
                                    <li class="list-group-item d-flex justify-content-between align-items-center px-0">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (amount < 300000) {
            Swal.fire({
                ...
                text: 'Minimum payout amount is ₦300,000.00',
                confirmButtonText: 'OK'
            });
            return;
        }
    ...
    amountInput.addEventListener('input', function() {
        ...
        if (amount > maxAmount) {
            ...
            submitBtn.disabled = amount < 300000;
        }
    });
});
</script>

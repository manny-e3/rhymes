                                ...
                                <div class="col-md-9">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            ...
                                            <?php if((request('lastupdated') && request('lastupdated') !== '2026-04-01') || request('start_date') || request('end_date') || request('name') || request('invoice_id')): ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/admin/erprev/sales.blade.php ENDPATH**/ ?>
...
<?php $__env->startSection('page-description', 'Manage system notifications and announcements'); ?>
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount"><?php echo e($stats['total'] ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount"><?php echo e($stats['unread'] ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount"><?php echo e($stats['today'] ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-6 col-lg-3">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount"><?php echo e($stats['active_users'] ?? 0); ?></span>
                                </div>
                            </div>
                        </div>
                    </div>
                                ...
                                <?php if(isset($notifications) && count($notifications) > 0): ?>
                                    <div class="nk-notification">
                                        <?php $__currentLoopData = $notifications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $notification): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="nk-notification-item <?php echo e($notification->read_at ? '' : 'is-unread'); ?>">
                                                <div class="nk-notification-icon">
                                                    <div class="icon-circle 
                                                        <?php if($notification->type === 'announcement'): ?> bg-primary-dim
                                                        <?php elseif($notification->type === 'system'): ?> bg-info-dim
                                                        <?php elseif($notification->type === 'promotion'): ?> bg-success-dim
                                                        <?php elseif($notification->type === 'maintenance'): ?> bg-warning-dim
                                                        <?php else: ?> bg-secondary-dim <?php endif; ?>">
                                                        <em class="icon ni ni-
                                                            <?php if($notification->type === 'announcement'): ?> bell
                                                            <?php elseif($notification->type === 'system'): ?> setting
                                                            <?php elseif($notification->type === 'promotion'): ?> gift
                                                            <?php elseif($notification->type === 'maintenance'): ?> tool
                                                            <?php else: ?> info <?php endif; ?>"></em>
                                                    </div>
                                                </div>
                                                <div class="nk-notification-content">
                                                    <div class="nk-notification-text">
                                                        <h6><?php echo e($notification->title); ?></h6>
                                                        <p><?php echo e(Str::limit($notification->message, 100)); ?></p>
                                                    </div>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <ul class="link-list-opt no-bdr">
                                                                <li><a href="#" onclick="viewNotification(<?php echo e($notification->id); ?>)"><em class="icon ni ni-eye"></em><span>View Details</span></a></li>
                                                                <?php if(!$notification->read_at): ?>
                                                                    <li><a href="#" onclick="markAsRead(<?php echo e($notification->id); ?>)"><em class="icon ni ni-check"></em><span>Mark as Read</span></a></li>
                                                                <?php endif; ?>
                                                                <li><a href="#" onclick="editNotification(<?php echo e($notification->id); ?>)"><em class="icon ni ni-edit"></em><span>Edit</span></a></li>
                                                                <li class="divider"></li>
                                                                <li><a href="#" class="text-danger" onclick="deleteNotification(<?php echo e($notification->id); ?>)"><em class="icon ni ni-trash"></em><span>Delete</span></a></li>
                                                            </ul>
                                                        </div>
                                                    </div>
                                                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhyme_app\resources\views/admin/notifications/index.blade.php ENDPATH**/ ?>
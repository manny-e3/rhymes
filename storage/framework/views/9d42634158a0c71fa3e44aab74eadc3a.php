<?php $__env->startSection('title', 'Wallet | Rhymes Author Platform'); ?>

<?php $__env->startSection('page-title', 'Wallet'); ?>

<?php $__env->startSection('page-description', 'Manage your earnings and view transaction history'); ?>
                    ...
                    <div class="nk-block-head-content">
                        <div class="nk-block-tools g-3">
                            <div class="nk-block-tools-opt">
                                <a href="<?php echo e(route('author.payouts.index')); ?>" class="btn btn-primary">
                        ...
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount">₦<?php echo e(number_format($balance, 2)); ?></span>
                                </div>
                                <div class="card-note">
                    ...
                    <div class="col-md-4">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount">₦<?php echo e(number_format($transactions->where('type', 'sale')->sum('amount'), 2)); ?></span>
                                </div>
                                <div class="card-note">
                    ...
                    <div class="col-md-4">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                ...
                                <div class="card-amount">
                                    <span class="amount"><?php echo e($transactions->where('type', 'sale')->count()); ?></span>
                                </div>
                                <div class="card-note">
                    ...
                    <div class="card-inner-group">
                        <div class="card-inner p-0">
                            <div class="nk-tb-list">
                                ...
                                <?php $__currentLoopData = $salesByBook; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="nk-tb-item">
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-info">
                                                <span class="tb-lead"><?php echo e($sale['title'] ?? 'Unknown Book'); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                        <span class="tb-amount"><?php echo e($sale['sales_count']); ?></span>
                                    </div>
                                    <div class="nk-tb-col tb-col-lg">
                                        <span class="tb-amount">₦<?php echo e(number_format($sale['total_sales'], 2)); ?></span>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                        <span class="tb-amount">₦<?php echo e(number_format($sale['total_sales'] / $sale['sales_count'], 2)); ?></span>
                                    </div>
                                </div>
                        ...
                        <div class="card-inner p-0">
                            <div class="nk-tb-list">
                                ...
                                <div class="nk-tb-item">
                                    <div class="nk-tb-col">
                                        <div class="user-card">
                                            <div class="user-avatar sq bg-<?php echo e($transaction->type === 'sale' ? 'success' : ($transaction->type === 'payout' ? 'warning' : 'info')); ?>">
                                                <em class="icon ni ni-<?php echo e($transaction->type === 'sale' ? 'coins' : ($transaction->type === 'payout' ? 'wallet-out' : 'percent')); ?>"></em>
                                            </div>
                                            <div class="user-info">
                                                <span class="tb-lead"><?php echo e(ucfirst($transaction->type)); ?></span>
                                                <span class="tb-sub"><?php echo e($transaction->created_at->format('M d, Y')); ?></span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="nk-tb-col tb-col-md">
                                    ...
                                    <div class="nk-tb-col tb-col-lg">
                                        <span class="tb-amount <?php echo e($transaction->amount > 0 ? 'text-success' : 'text-danger'); ?>">
                                    ...
                                    <div class="nk-tb-col tb-col-sm">
                                        <span class="badge badge-dot badge-<?php echo e($transaction->type === 'sale' ? 'success' : ($transaction->type === 'payout' ? 'warning' : 'info')); ?>">
...
function showExportModal() {
    Swal.fire({
        ...
        html: `
            <form id="exportForm" action="<?php echo e(route('author.wallet.export')); ?>" method="GET">
                <div class="row g-3">
                    <div class="col-12">
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.author', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/author/wallet/index.blade.php ENDPATH**/ ?>
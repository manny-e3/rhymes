...
<head>
    <meta charset="utf-8">
    <title><?php echo e($subject); ?> - Rhymes Platform</title>
</head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; background-color: #f5f7fa; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: linear-gradient(135deg, #F2426E 0%, #e74c3c 100%); padding: 30px; text-align: center; color: white;">
            ...
            <p style="margin: 10px 0 0; font-size: 16px; opacity: 0.9;"><?php echo e($subject); ?></p>
        </div>
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="font-size: 16px; color: #4b5563; margin-bottom: 25px; line-height: 1.8;">
                ...
                ?>
                <?php echo nl2br(e($displayMessage)); ?>

            </div>
            
            <?php if(isset($cta_url) && isset($cta_text)): ?>
            <div style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e($cta_url); ?>" style="display: inline-block; background: linear-gradient(135deg, #F2426E 0%, #e74c3c 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px; box-shadow: 0 4px 6px rgba(242, 66, 110, 0.3);">
                    <?php echo e($cta_text); ?>
...
</html><?php /**PATH C:\xampp\htdocs\rhyme_app\resources\views/emails/generic-email.blade.php ENDPATH**/ ?>
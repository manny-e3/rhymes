...
<head>
    <meta charset="utf-8">
    <title>Your Login Code - Rhymes Platform</title>
</head>
<body style="font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; line-height: 1.6; color: #333; background-color: #f5f7fa; margin: 0; padding: 0;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
        ...
        <div style="background: linear-gradient(135deg, #F2426E 0%, #e74c3c 100%); padding: 30px; text-align: center; color: white;">
            ...
            <p style="margin: 10px 0 0; font-size: 16px; opacity: 0.9;">Secure Login Verification</p>
        </div>
        ...
        <div style="padding: 40px 30px;">
            ...
            <p style="font-size: 16px; color: #4b5563; margin-bottom: 25px;">
                You're receiving this email because a login attempt was made on your Rhymes Platform account.
            </p>
            
            <div style="background: #eff6ff; border-radius: 8px; padding: 25px; margin: 30px 0; border-left: 4px solid #3b82f6;">
                <h3 style="color: #1f2937; margin-top: 0; font-size: 20px;">🔐 Your One-Time Password (OTP)</h3>
            ...
            <div style="background: #fffbeb; border-radius: 8px; padding: 20px; border-left: 4px solid #f59e0b; margin-bottom: 30px;">
                <p style="margin: 0; font-size: 15px; color: #92400e;">
                    <strong>Didn't try to log in?</strong> If you didn't attempt to sign in to your account, someone else might have access to your credentials. Please change your password immediately.
                </p>
            </div>
...
</html><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/emails/otp-code.blade.php ENDPATH**/ ?>
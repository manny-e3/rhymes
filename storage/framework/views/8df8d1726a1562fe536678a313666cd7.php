...
<?php $__env->startSection('page-title', 'Two-Factor Authentication'); ?>

<?php $__env->startSection('page-description', 'Enter the code sent to your email address'); ?>

<?php $__env->startSection('content'); ?>
<form method="POST" action="<?php echo e(route('otp.verify')); ?>" id="otp-verify-form">
    <?php echo csrf_field(); ?>
...
<div class="form-note-s2 text-center pt-4">
    <p>
        ...
        <form method="POST" action="<?php echo e(route('otp.resend')); ?>" id="otp-resend-form" style="display: inline;">
            <?php echo csrf_field(); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/auth/otp.blade.php ENDPATH**/ ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    form.addEventListener('submit', function(e) {
        ...
        if (amount < minPayoutAmount) {
            Swal.fire({
                ...
                text: `Minimum payout amount is ₦${minPayoutAmount.toLocaleString('en-NG', { minimumFractionDigits: 2 })}`,
                confirmButtonText: 'OK'
            });
            return;
        }
    ...
    amountInput.addEventListener('input', function() {
        ...
        if (amount > maxAmount) {
            ...
            submitBtn.disabled = amount < minPayoutAmount;
        }
    });
});
</script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.author', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/author/payouts/index.blade.php ENDPATH**/ ?>
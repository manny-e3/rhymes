    ...
    <div class="container">
        ...
        <div class="content">
            ...
            <div class="recall-info">
                ...
                <p>The author <strong><?php echo e($author->name); ?></strong> (<?php echo e($author->email); ?>) has requested to recall their book:</p>
                <h4 style="color: #1f2937;"><?php echo e($book->title); ?></h4>
            </div>
            ...
            <div class="book-details">
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <tr>
                        ...
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($author->name); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><strong>Email:</strong></td>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($author->email); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><strong>Book Title:</strong></td>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($book->title); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><strong>Genre:</strong></td>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($book->genre); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><strong>ISBN:</strong></td>
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($book->isbn ?? 'N/A'); ?></td>
                    </tr>
                    <tr>
                        ...
                        <td style="padding: 8px; border: 1px solid #e5e7eb;">
                            <span style="background-color: #dbeafe; color: #1e40af; padding: 4px 8px; border-radius: 4px;">
                                <?php echo e(ucfirst(str_replace('_', ' ', $book->status))); ?>
                    ...
                    <tr>
                        ...
                        <td style="padding: 8px; border: 1px solid #e5e7eb;"><?php echo e($book->created_at->format('M d, Y')); ?></td>
                    </tr>
                </table>
            </div>
            ...
            <div class="reason-section">
                ...
                <p style="margin: 10px 0;"><?php echo e($recallReason); ?></p>
            </div>
            <?php else: ?>
            <div class="reason-section">
                <h4 style="margin-top: 0; color: #d97706;">Recall Reason</h4>
...
</html><?php /**PATH C:\xampp\htdocs\rhyme_app\resources\views/emails/book-recall-notification.blade.php ENDPATH**/ ?>
...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; border-radius: 8px; padding: 30px; margin-bottom: 30px;">
            ...
            <?php // Debug information - can be removed later ?>
            <?php /* ?>
            <p style="color: red; font-size: 12px;">DEBUG: newStatus = "{{ $newStatus }}"</p>
            <p style="color: red; font-size: 12px;">DEBUG: newStatus length = {{ strlen($newStatus) }}</p>
            <p style="color: red; font-size: 12px;">DEBUG: approved_awaiting_delivery length = {{ strlen('approved_awaiting_delivery') }}</p>
            <p style="color: red; font-size: 12px;">DEBUG: Comparison result = {{ var_export($newStatus === 'approved_awaiting_delivery', true) }}</p>
            <?php */ ?>
            
            <?php if(trim($newStatus) === 'approved_awaiting_delivery'): ?>
                <p>Your book "<strong><?php echo e($book->title); ?></strong>" status has been changed to <strong><?php echo e(ucfirst(str_replace('_', ' ', $newStatus))); ?></strong>.</p>
                <p>This status notifies you to deliver physical copies of the book.</p>

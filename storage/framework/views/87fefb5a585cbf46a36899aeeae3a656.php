<?php $__env->startSection('title', 'Edit Book | Rhymes Author Platform'); ?>
<?php $__env->startSection('page-title', 'Edit Book'); ?>
<?php $__env->startSection('page-description', 'Update book information'); ?>
                    ...
                    <div class="col-lg-8">
                        <div class="card card-bordered">
                            <div class="card-inner">
                                <form action="<?php echo e(route('author.books.update', $book)); ?>" method="POST" enctype="multipart/form-data">
                                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="genre" name="genre" required>
                                                        ...
                                                        <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            <?php if(is_array($category)): ?>
                                                                <option value="<?php echo e($category['name']); ?>" <?php echo e(old('genre', $book->genre) == $category['name'] ? 'selected' : ''); ?> data-id="<?php echo e($category['id']); ?>"><?php echo e($category['name']); ?></option>
                                                            <?php else: ?>
                                                                <option value="<?php echo e($category); ?>" <?php echo e(old('genre', $book->genre) == $category ? 'selected' : ''); ?>><?php echo e($category); ?></option>
                                                            <?php endif; ?>
...
unset($__errorArgs, $__bag); ?>" 
                                                           id="price" name="price" value="<?php echo e(old('price', $book->price)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" 
                                                              id="description" name="description" rows="4" required><?php echo e(old('description', $book->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <div class="form-control-wrap">
                                                    <div class="fancy-upload-zone" id="upload-zone" onclick="document.getElementById('image').click()" <?php if($book->image): ?> style="display: none;" <?php endif; ?>>
...
unset($__errorArgs, $__bag); ?>
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <a href="<?php echo e(route('author.books.show', $book)); ?>" class="btn btn-outline-light">Cancel</a>
                                            </div>
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="row gy-3">
                                            ...
                                            <div class="form-control-wrap">
                                                <?php switch($book->status):
                                                    ...
                                                    <?php case ('stocked'): ?>
                                                        ...
                                                        <?php break; ?>
                                                    <?php case ('edited_pending_approval'): ?>
                                    ...
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" value="<?php echo e($book->created_at->format('M d, Y')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-12">
                                        <div class="form-group">
                                            ...
                                            <div class="form-control-wrap">
                                                <input type="text" class="form-control" value="<?php echo e($book->updated_at->format('M d, Y')); ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.author', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/author/books/edit.blade.php ENDPATH**/ ?>
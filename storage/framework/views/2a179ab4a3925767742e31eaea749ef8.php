    ...
    <div class="form-group">
        <div class="form-label-group d-flex justify-content-between align-items-center">
            ...
            <?php if(Route::has('password.request')): ?>
                <a class="link link-sm" href="<?php echo e(route('password.request')); ?>">Forgot Password?</a>
            <?php endif; ?>
        </div>
...
<?php echo $__env->make('layouts.auth', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/auth/login.blade.php ENDPATH**/ ?>
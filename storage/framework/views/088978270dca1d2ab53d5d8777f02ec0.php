        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            <?php if(session('success')): ?>
                Swal.fire({
                    icon: 'success',
                    title: 'Success!',
                    html: `<?php echo nl2br(e(session('success'))); ?>`,
                    timer: 3000,
            ...
            <?php if(session('warning')): ?>
                Swal.fire({
                    icon: 'warning',
                    title: 'Warning!',
                    html: `<?php echo nl2br(e(session('warning'))); ?>`,
                    showConfirmButton: true,
                    confirmButtonText: 'OK',
            ...
            <?php if(session('info')): ?>
                Swal.fire({
                    icon: 'info',
                    title: 'Info',
                    html: `<?php echo nl2br(e(session('info'))); ?>`,
                    timer: 3000,
                    timerProgressBar: true,
                    showConfirmButton: false,
                    toast: true,
...
</html><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/layouts/author.blade.php ENDPATH**/ ?>
                ...
                <div class="card card-bordered card-stretch">
                    <div class="card-inner-group">
                                        ...
                                        <li>
                                            <div class="form-control-wrap">
                                                <div class="input-group input-group-sm">
                                                    <input type="text" class="form-control" id="tableSearch" value="<?php echo e(request('search')); ?>" placeholder="Search transactions..." onkeyup="if(event.keyCode == 13) searchTransactions()">
                                ...
                                <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $transaction): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <div class="nk-tb-item">
                                        <div class="nk-tb-col">
                                            ...
                                            <span class="tb-sub"><?php echo e($transaction->book->isbn ?? 'No ISBN'); ?></span>
                                            <?php if(!empty($transaction->meta['invoice_id'])): ?>
                                                <span class="tb-sub text-primary">Invoice: #<?php echo e($transaction->meta['invoice_id']); ?></span>
                                            <?php endif; ?>
                                        </div>
                                        ...
                                        <div class="nk-tb-col tb-col-md">
                                            <span class="tb-lead"><?php echo e($transaction->meta['quantity_sold'] ?? 1); ?></span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                                            <span class="tb-lead"><?php echo e($transaction->meta['location'] ?? 'N/A'); ?></span>
                                        </div>
                                        <div class="nk-tb-col tb-col-lg">
                        ...
                        <?php if($transactions->hasPages()): ?>
                            <div class="card-inner">
                                <?php echo e($transactions->appends(request()->query())->links('vendor.pagination.bootstrap-4')); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\authors_portal\resources\views/admin/reports/sales.blade.php ENDPATH**/ ?>
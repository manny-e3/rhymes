                            ...
                            <form method="GET" action="<?php echo e(route('admin.erprev.sales')); ?>" class="row g-3 align-items-end">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="lastupdated" id="lastupdated" class="form-select">
                                                <option value="" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '' ? 'selected' : ''); ?>>All Time</option>
                                                <option value="all" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == 'all' ? 'selected' : ''); ?>>All Records</option>
                                                <option value="5m" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '5m' ? 'selected' : ''); ?>>Last 5 Minutes</option>
                                                <option value="10m" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '10m' ? 'selected' : ''); ?>>Last 10 Minutes</option>
                                                <option value="30m" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '30m' ? 'selected' : ''); ?>>Last 30 Minutes</option>
                                                <option value="1h" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '1h' ? 'selected' : ''); ?>>Last 1 Hour</option>
                                                <option value="4h" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '4h' ? 'selected' : ''); ?>>Last 4 Hours</option>
                                                <option value="6h" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '6h' ? 'selected' : ''); ?>>Last 6 Hours</option>
                                                <option value="24h" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '24h' ? 'selected' : ''); ?>>Last 24 Hours</option>
                                                <option value="7d" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '7d' ? 'selected' : ''); ?>>Last 7 Days</option>
                                                <option value="30d" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '30d' ? 'selected' : ''); ?>>Last 30 Days</option>
                                                <option value="60d" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '60d' ? 'selected' : ''); ?>>Last 60 Days</option>
                                                <option value="100d" <?php echo e(request('lastupdated', $filters['lastupdated'] ?? '100d') == '100d' ? 'selected' : ''); ?>>Last 100 Days</option>
                                            </select>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="barcode" name="barcode" placeholder="Enter barcode or ID" value="<?php echo e(request('barcode')); ?>">
                                        </div>
                                    </div>
                                </div>
...
<script>
    document.getElementById('btn-sync-sales').addEventListener('click', function() {
        ...
        fetch('<?php echo e(route("api.erprev.sync-sales-deep")); ?>?lastupdated=2026-04-01&dry_run=0&status=all')
            .then(response => {
                if (!response.ok) {

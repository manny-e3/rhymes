                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control form-control-sm" id="id" name="id" placeholder="Enter product ID" value="<?php echo e(request('id')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            ...
                                            <?php if(request('id') || request('name') || request('barcode')): ?>
                                                <a href="<?php echo e(route('admin.erprev.products')); ?>" class="btn btn-secondary"><em class="icon ni ni-reload"></em><span>Clear</span></a>
                                            <?php endif; ?>
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/admin/erprev/products.blade.php ENDPATH**/ ?>
        ...
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0 font-size-18">
                    <?php if($type == 'newsletter'): ?> Send Newsletter
                    <?php elseif($type == 'announcement'): ?> Send Announcement
                    <?php elseif($type == 'sales_report'): ?> Send Sales Report
                    <?php else: ?> Send Bulk Email
                    <?php endif; ?>
                </h4>
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title mb-0">
                        <?php if($type == 'newsletter'): ?> Compose Newsletter
                        <?php elseif($type == 'announcement'): ?> Compose Announcement
                        <?php elseif($type == 'sales_report'): ?> Sales Report Configuration
                        <?php else: ?> Compose Bulk Email
                        <?php endif; ?>
                    </h4>
                </div>
                <div class="card-body">
                    ...
                    <form action="<?php echo e(route('admin.emails.newsletter.send')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select name="author_ids[]" id="author_ids" class="form-control select2" multiple>
                                <?php $__currentLoopData = $authors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $author): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($author->id); ?>"><?php echo e($author->name); ?> (<?php echo e($author->email); ?>)</option>
                    ...
                    <form action="<?php echo e(route('admin.emails.announcement.send')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="mb-3">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane active" id="single_author" role="tabpanel">
                            <form action="<?php echo e(route('admin.emails.sales-report.send')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                        ...
                        <div class="tab-pane" id="bulk_authors" role="tabpanel">
                            <form action="<?php echo e(route('admin.emails.bulk-sales-reports.send')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="mb-3">
                    ...
                    <?php else: ?>
                    <form action="<?php echo e(route('admin.emails.bulk.send')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <div class="mb-3">
                            ...
                            <select name="recipients[]" id="recipients" class="form-control select2" multiple required>
                                <?php $__currentLoopData = $allUsers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($user->id); ?>"><?php echo e($user->name); ?> (<?php echo e($user->email); ?>) <?php if($user->hasRole('author')): ?> - Author <?php endif; ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </select>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhyme_app\resources\views/admin/emails/create.blade.php ENDPATH**/ ?>
<?php $__env->startSection('title', 'User Dashboard | Rhymes Platform'); ?>
                ...
                <div class="nk-wg7">
                    ...
                    <div class="nk-wg7-stats mb-4">
                        ...
                        <div class="progress progress-lg">
                            <div class="progress-bar <?php echo e($progressClass); ?>" role="progressbar" style="width: <?php echo e($overallProgress); ?>%"></div>
                        </div>
                        <div class="progress-step mt-2">
                            <div class="progress-info">
                                <span class="progress-label"><?php echo e($progressLabel); ?></span>
                        ...
                        <div class="card card-full mb-3">
                            <div class="card-inner p-3">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <h6 class="title mb-0"><?php echo e(Str::limit($book->title, 40)); ?></h6>
                                    <span class="badge bg-<?php echo e($book->status === 'accepted' ? 'success' : ($book->status === 'rejected' ? 'danger' : 'warning')); ?>">
                                ...
                                <div class="alert alert-light mt-2 mb-0 p-2">
                                    <small class="text-muted"><strong>Notes:</strong> <?php echo e(Str::limit($book->admin_notes, 80)); ?></small>
                                </div>
                                <?php endif; ?>
                            </div>
                        </div>
                ...
                <div class="between-center flex-wrap flex-md-nowrap g-3">
                    ...
                    <div class="nk-block-actions flex-shrink-sm-0">
                        <div class="justify-center">
                            <a href="<?php echo e(route('user.books.create')); ?>" class="btn btn-primary">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/dashboard.blade.php ENDPATH**/ ?>
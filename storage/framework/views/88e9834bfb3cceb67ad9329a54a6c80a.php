...
<body style="font-family: Arial, sans-serif; line-height: 1.6; color: #333;">
    <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
        ...
        <div style="background: #f9fafb; border-radius: 8px; padding: 30px; margin-bottom: 30px;">
            <h2 style="color: #1f2937; margin-top: 0;">Hello <?php echo e($admin->name); ?>,</h2>
            ...
            <div style="background: #eff6ff; border-radius: 6px; padding: 20px; margin: 25px 0;">
                ...
                <table style="width: 100%; border-collapse: collapse; margin: 15px 0;">
                    <tr>
                        ...
                        <td style="padding: 8px; vertical-align: top;"><?php echo e($payout->user->name); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; vertical-align: top;"><strong>Author Email:</strong></td>
                        <td style="padding: 8px; vertical-align: top;"><?php echo e($payout->user->email); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; vertical-align: top;"><strong>Amount Requested:</strong></td>
                        <td style="padding: 8px; vertical-align: top;">₦<?php echo e(number_format($payout->amount_requested, 2)); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; vertical-align: top;"><strong>Payment Method:</strong></td>
                        <td style="padding: 8px; vertical-align: top;"><?php echo e(ucfirst($payout->payment_method)); ?></td>
                    </tr>
                    <tr>
                        <td style="padding: 8px; vertical-align: top;"><strong>Requested Date:</strong></td>
                        <td style="padding: 8px; vertical-align: top;"><?php echo e($payout->created_at->format('M d, Y \a\t g:i A')); ?></td>
                    </tr>
                </table>
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="<?php echo e(url('/admin/payouts/' . $payout->id)); ?>" 
...
</html><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/emails/admin-payout-requested.blade.php ENDPATH**/ ?>
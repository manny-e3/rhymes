                                    ...
                                    <div class="row g-4">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="min_payout_amount" value="<?php echo e($settings['min_payout_amount'] ?? 50000); ?>" min="1" step="0.01" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="author_commission_percentage" value="<?php echo e($settings['author_commission_percentage'] ?? 75); ?>" min="0" max="100" step="0.1" required>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" name="payout_frequency_days" value="<?php echo e($settings['payout_frequency_days'] ?? 1); ?>" min="1" max="365" required>
                            ...
                            <div class="card-inner">
                                ...
                                <ul class="nk-list-meta">
                                    <li class="nk-list-meta-item">
                                        ...
                                        <span class="nk-list-meta-value">₦<?php echo e(number_format($settings['min_payout_amount'] ?? 50000, 2)); ?></span>
                                    </li>
                                    <li class="nk-list-meta-item">
                                        <span class="nk-list-meta-label">Author Commission:</span>
                                        <span class="nk-list-meta-value"><?php echo e($settings['author_commission_percentage'] ?? 75); ?>% (Platform: <?php echo e(100 - ($settings['author_commission_percentage'] ?? 75)); ?>%)</span>
                                    </li>
                                    <li class="nk-list-meta-item">
                                    ...
                                    <li class="nk-list-meta-item">
                                        ...
                                        <span class="nk-list-meta-value">Once every <?php echo e($settings['payout_frequency_days'] ?? 1); ?> day(s)</span>
                                    </li>
                                </ul>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="<?php echo e(route('admin.dashboard')); ?>" class="nk-menu-link " style="color: #364a63">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        ...
                                        <!-- <li class="nk-menu-item">
                                            <a href="<?php echo e(route('admin.erprev.test-endpoints')); ?>" class="nk-menu-link"><span class="nk-menu-text">Test Endpoints</span></a>
                                        </li>
                                        <li class="nk-menu-item">
...
</html><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/layouts/admin.blade.php ENDPATH**/ ?>
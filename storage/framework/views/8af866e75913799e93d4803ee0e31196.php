                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                <div class="form-control-wrap">
                                    <input type="number" class="form-control" name="quantity" value="<?php echo e($book->quantity ?? 0); ?>" required min="0">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="form-label">REV Book ID</label>
                                <div class="form-control-wrap">
                                    <input type="text" class="form-control" name="rev_book_id" value="<?php echo e($book->rev_book_id); ?>" maxlength="50" placeholder="e.g. 1234567890">
                                </div>
                            </div>
                        </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\authors_portal\resources\views/admin/books/index.blade.php ENDPATH**/ ?>
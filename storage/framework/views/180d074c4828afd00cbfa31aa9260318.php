    ...
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body modal-body-lg">
                ...
                <form id="payment-details-form" class="form-validate is-alter" method="POST" action="<?php echo e(route('author.profile.payment-details.update')); ?>">
                    <?php echo csrf_field(); ?>
...
</script><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/author/profile/modals/payment-details.blade.php ENDPATH**/ ?>
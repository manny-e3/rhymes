                ...
                <div class="card card-bordered card-full">
                    <div class="card-inner">
                        ...
                        <div class="card-inner mb-3">
                            <form method="GET" action="<?php echo e(route('admin.erprev.inventory')); ?>" class="row g-3 align-items-end">
                                <div class="col-md-3">
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <input type="text" class="form-control" id="product" name="product" placeholder="Enter product name" value="<?php echo e(request('product')); ?>">
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <div class="form-control-wrap">
                                            ...
                                            <!-- <?php if(request('lastupdated') || request('product') || request('barcode')): ?>
                                                <a href="<?php echo e(route('admin.erprev.inventory')); ?>" class="btn btn-secondary"><em class="icon ni ni-reload"></em><span>Clear Filter</span></a>
                                            <?php endif; ?> -->
                                        </div>
                                    </div>
                                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/rovinghe/author.rovingheights.com/resources/views/admin/erprev/inventory.blade.php ENDPATH**/ ?>
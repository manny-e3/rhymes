<?php $__env->startSection('title', 'Create User | Admin Panel'); ?>

<?php $__env->startSection('page-title', 'Create User'); ?>

<?php $__env->startSection('page-description', 'Add a new user to the platform'); ?>
            ...
            <div class="nk-block">
                <div class="card card-bordered">
                    <div class="card-inner">
                        <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" class="form-validate">
                            <?php echo csrf_field(); ?>
                            <div class="row g-4">
                                <div class="col-lg-6">
...
unset($__errorArgs, $__bag); ?>
                                ...
                                <div class="col-12">
                                    <div class="form-group">
                                        ...
                                        <a href="<?php echo e(route('admin.users.index')); ?>" class="btn btn-lg btn-outline-light">Cancel</a>
                                    </div>
                                </div>
                            </div>
                        </form>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rhyme_app\resources\views/admin/users/create.blade.php ENDPATH**/ ?>
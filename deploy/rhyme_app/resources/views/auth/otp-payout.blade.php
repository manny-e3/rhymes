...
@section('page-title', 'Payout Authorization')

@section('page-description', 'Enter the code sent to your email address to authorize this payout')

@section('content')
<form method="POST" action="{{ route('otp.payout.verify') }}" id="otp-verify-form">
    @csrf
...
<div class="form-note-s2 text-center pt-4">
    <p>
        ...
        <form method="POST" action="{{ route('otp.payout.resend') }}" id="otp-resend-form" style="display: inline;">
            @csrf

                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-success p-3">
                                ...
                                <h3 class="mb-0">{{ $stats['total_authors'] ?? 0 }}</h3>
                            </div>
                        </div>
                        <div class="col-5 align-self-end">
                            <div class="py-4 text-center">
                    ...
                    <div class="row">
                        <div class="col-7">
                            <div class="text-warning p-3">
                                ...
                                <h3 class="mb-0">{{ $stats['pending_emails'] ?? 0 }}</h3>
                            </div>
                        </div>
                        <div class="col-5 align-self-end">
                            <div class="py-4 text-center">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.create') }}?type=newsletter" class="btn btn-primary">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.create') }}?type=announcement" class="btn btn-info">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.create') }}?type=sales_report" class="btn btn-success">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.personal.form') }}" class="btn btn-warning">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.create') }}?type=bulk" class="btn btn-secondary">
        ...
        <div class="col-xl-4 col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <a href="{{ route('admin.emails.logs') }}" class="btn btn-dark">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex align-items-center justify-content-between">
                        ...
                        <a href="{{ route('admin.emails.logs') }}" class="btn btn-sm btn-primary">View All</a>
                    </div>
                </div>
                <div class="card-body">

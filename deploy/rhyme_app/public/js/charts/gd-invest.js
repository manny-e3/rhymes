!(function (NioApp, $) {
    ...
    var totalDeposit = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#da251c", .2),NioApp.hexRGB("#da251c", .2),NioApp.hexRGB("#da251c", .2),NioApp.hexRGB("#da251c", .2),NioApp.hexRGB("#da251c", .2),NioApp.hexRGB("#da251c", .2),"#da251c"],

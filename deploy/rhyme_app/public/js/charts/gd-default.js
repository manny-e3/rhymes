!(function (NioApp, $) {
    ...
    var profileBalance = {
        ...
        datasets : [{
            ...
            color : "#da251c",
            background : NioApp.hexRGB('#da251c',.3),
    ...
    var salesRevenue = {
        ...
        datasets : [{
            label : "Sales Revenue",
            color : [NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),"#364a63"],
    ...
    var activeSubscription = {
        ...
        datasets : [{
            label : "Active User",
            color : [NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),NioApp.hexRGB("#364a63", .2),"#364a63"],
    ...
    var salesOverview = {
        ...
        datasets : [{
            ...
            color : "#364a63",
            background : NioApp.hexRGB('#364a63',.3),

...
!function (NioApp, $) {
  ...
  var totalDeposit = {
    ...
    datasets: [{
      label: "Active User",
      color: [NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2), NioApp.hexRGB("#364a63", .2), "#364a63"],

            ...
            <div class="nk-sidebar nk-sidebar-fixed is-light " data-content="sidebarMenu">
                <div class="nk-sidebar-element nk-sidebar-head">
                    <div class="nk-sidebar-brand">
                            ...
                            <img class=""  height="100px"  src="{{asset('/images/rovingHeights-logo.png')}}" srcset="{{ asset('images/rovingHeights-logo.png 2x') }}" alt="logo-dark">
                        ...
                        <div class="nk-sidebar-menu" data-simplebar>
                            <ul class="nk-menu">
                                ...
                                <li class="nk-menu-item has-sub">
                                    <a href="{{ route('admin.dashboard') }}" class="nk-menu-link " style="color: #364a63">
                                ...
                                <li class="nk-menu-item has-sub">
                                    ...
                                    <ul class="nk-menu-sub">
                                        <li class="nk-menu-item">
                                            <a href="{{ route('admin.revenue.index') }}" class="nk-menu-link"><span class="nk-menu-text">Revenue</span></a>
                                        </li>
                                        <li class="nk-menu-item">
                                            <a href="{{ route('admin.payouts.index') }}" class="nk-menu-link"><span class="nk-menu-text">Payouts</span></a>
                                        </li>
                                    </ul><!-- .nk-menu-sub -->
                                </li><!-- .nk-menu-item -->

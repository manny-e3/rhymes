                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                @endphp
                                <input type="text" class="form-control" value="{{ ucfirst(str_replace('_', ' ', $profileMethod)) }}" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-12">
                        <div class="form-group">
                            ...
                            <div class="form-control-wrap">
                                ...
                                @endphp
                                <textarea class="form-control" rows="3" readonly>{{ $displayText ?: 'Payment details incomplete in profile.' }}</textarea>
                            </div>
                        </div>
                    </div>
                    @else

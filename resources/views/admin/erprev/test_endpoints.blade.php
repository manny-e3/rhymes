                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-control-wrap">
                                            <select name="lastupdated" id="lastupdated" class="form-select">
                                                <option value="all" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == 'all') ? 'selected' : '' }}>All Records (all)</option>
                                                <option value="5m" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '5m') ? 'selected' : '' }}>Last 5 Minutes (5m)</option>
                                                <option value="10m" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '10m') ? 'selected' : '' }}>Last 10 Minutes (10m)</option>
                                                <option value="30m" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '30m') ? 'selected' : '' }}>Last 30 Minutes (30m)</option>
                                                <option value="1h" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '1h') ? 'selected' : '' }}>Last 1 Hour (1h)</option>
                                                <option value="4h" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '4h') ? 'selected' : '' }}>Last 4 Hours (4h)</option>
                                                <option value="6h" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '6h') ? 'selected' : '' }}>Last 6 Hours (6h)</option>
                                                <option value="24h" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '24h') ? 'selected' : '' }}>Last 24 Hours (24h)</option>
                                                <option value="7d" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '7d') ? 'selected' : '' }}>Last 7 Days (7d)</option>
                                                <option value="30d" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '30d') ? 'selected' : '' }}>Last 30 Days (30d)</option>
                                                <option value="60d" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '60d') ? 'selected' : '' }}>Last 60 Days (60d)</option>
                                                <option value="100d" {{ (isset($selectedLastUpdated) && $selectedLastUpdated == '100d') ? 'selected' : '' }}>Last 100 Days (100d)</option>
                                            </select>
                                        </div>
